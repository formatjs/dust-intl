 ...
 function (root, factory) {
    ...
    */
    function intlMessage(chunk, context, bodies, params) {
        ...
        if (!params.hasOwnProperty('_msg') && !params._key) {
            throw new ReferenceError('A message name or string must be provided.');
        }
        ...
        // since params might be interpretted as format options
        delete params._msg;
        delete params._key;
        ...
        formatter = new IntlMessageFormat(msg, locale, formatOptions);
